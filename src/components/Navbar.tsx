      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-18 py-4">
          ...
          <a href="#" className="flex items-center gap-2">
            ...
            <div>
              <span className={`text-lg font-serif font-bold tracking-tight ${isScrolled ? "text-foreground" : "text-primary-foreground"}`}>
                DeluxMed
              </span>
              <span className={`block text-[10px] uppercase tracking-widest -mt-1 ${isScrolled ? "text-muted-foreground" : "text-primary-foreground/60"}`}>
                Health Group
              </span>
            </div>
          </a>
          ...
          <button
            ...
            className={`md:hidden p-2 rounded-lg ${isScrolled ? "text-foreground" : "text-primary-foreground"}`}
          >
